...
class CajetafpCopy3Widget extends StatefulWidget {
  const CajetafpCopy3Widget({Key key}) : super(key: key);

  @override
  _CajetafpCopy3WidgetState createState() => _CajetafpCopy3WidgetState();
}

class _CajetafpCopy3WidgetState extends State<CajetafpCopy3Widget> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Nuestro característico espresso se combina con salsa de chocolate blanco, leche al vapor y crema batida crean esta delicia suprema de chocolate blanco.',
