...
class CajetafpCopy2Widget extends StatefulWidget {
  const CajetafpCopy2Widget({Key key}) : super(key: key);

  @override
  _CajetafpCopy2WidgetState createState() => _CajetafpCopy2WidgetState();
}

class _CajetafpCopy2WidgetState extends State<CajetafpCopy2Widget> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Leche perfectamente vaporizada, recibe los característicos shots de ristretto, de nuestro intenso espresso.',
