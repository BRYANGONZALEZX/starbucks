...
class CajetafpCopyWidget extends StatefulWidget {
  const CajetafpCopyWidget({Key key}) : super(key: key);

  @override
  _CajetafpCopyWidgetState createState() => _CajetafpCopyWidgetState();
}

class _CajetafpCopyWidgetState extends State<CajetafpCopyWidget> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'El jarabe de caramelo se encuentra con el café, la leche y el hielo para una cita en la licuadora, mientras que la crema batida y la salsa de caramelo con mantequilla cubren de amor por encima.',
